<x-app-layout>
    <div class="relative min-h-screen overflow-x-hidden bg-white text-gray-900 dark:bg-gradient-to-br dark:from-[#0f2027] dark:via-[#203a43] dark:to-[#2c5364] dark:text-white">
        ...
        <div class="relative w-[90%] mx-auto py-10">
            ...
            <div class="flex justify-center mb-8">
                <form method="GET" action="{{ route('user.products') }}" class="flex flex-wrap gap-4 items-end bg-white border border-gray-200 shadow-lg dark:bg-white/10 dark:backdrop-blur-xl dark:border-white/20 p-4 rounded-xl w-full max-w-7xl">
                    ...
                    <div class="flex-1 min-w-[160px]">
                        ...
                        <select name="sort" onchange="this.form.submit()" class="w-full h-10 py-1 text-sm border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-[#2c3e50] text-gray-900 dark:text-gray-100 focus:ring-blue-500">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" class="w-full h-10 py-1 text-sm border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-[#2c3e50] text-gray-900 dark:text-gray-100 focus:ring-blue-500" placeholder="Product name...">
                    </div>
                    ...
                    <div class="flex-1 min-w-[160px]">
                        ...
                        <select name="category" onchange="this.form.submit()" class="w-full h-10 py-1 text-sm border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-[#2c3e50] text-gray-900 dark:text-gray-100 focus:ring-blue-500">
                    ...
                    <div class="flex items-end gap-2">
                        <div class="w-24">
                            ...
                            <input type="number" name="min_price" value="{{ request('min_price') }}" class="w-full h-10 py-1 text-sm border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-[#2c3e50] text-gray-900 dark:text-gray-100 focus:ring-blue-500" placeholder="₹ Min">
                        </div>
                        <div class="w-24">
                            ...
                            <input type="number" name="max_price" value="{{ request('max_price') }}" class="w-full h-10 py-1 text-sm border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-[#2c3e50] text-gray-900 dark:text-gray-100 focus:ring-blue-500" placeholder="₹ Max">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 pb-2">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="in_stock" value="1" {{ request('in_stock') ? 'checked' : '' }} onchange="this.form.submit()" class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 dark:bg-white/10 dark:border-white/20">
                            <span class="text-xs font-semibold text-gray-600 dark:text-white/70 group-hover:text-blue-500 transition">In Stock</span>
                        </label>
                        
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="on_sale" value="1" {{ request('on_sale') ? 'checked' : '' }} onchange="this.form.submit()" class="w-4 h-4 rounded border-gray-300 text-red-600 focus:ring-red-500 dark:bg-white/10 dark:border-white/20">
                    ...
                    <div class="flex gap-2">
                        <button type="submit" class="px-5 py-2.5 rounded-lg text-white bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/20 transition active:scale-95 text-sm font-bold">
                            Filter
                        </button>
                        <a href="{{ route('user.products') }}" class="px-4 py-2.5 rounded-lg border border-gray-300 dark:border-white/20 hover:bg-gray-100 dark:hover:bg-white/10 dark:text-white transition text-sm font-medium">
                            Reset
                        </a>
                    </div>
                </form>
            ...
            @else
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    @foreach ($products as $product)
                        <div class="p-4 rounded-xl transition duration-200 bg-white border border-gray-200 shadow-sm dark:bg-white/10 dark:backdrop-blur-xl dark:border-white/20 dark:shadow-md hover:shadow-md dark:hover:shadow-lg">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                @if($product->stock == 0)
                                    <button disabled class="bg-gray-300 text-gray-500 px-3 py-1 rounded cursor-not-allowed text-sm">
                                        Out of Stock
                                    </button>
                                ...
                                <a href="{{ route('user.products.show', $product) }}" class="text-sm text-gray-500 hover:text-gray-700 dark:text-white/60 dark:hover:text-cyan-400">
                                    View →
                                </a>
                            </div>
