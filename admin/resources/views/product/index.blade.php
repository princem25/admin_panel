        ...
        <div class="relative max-w-7xl mx-auto p-6">
            ...
            <div class="flex justify-between gap-4 flex-wrap">
                ...
                <div class="flex flex-row gap-3 absolute right-10 top-0">
                    ...
                    class="no-transition inline-block px-5 h-10 mt-5 py-2 bg-green-600 text-white font-medium rounded-lg shadow hover:bg-green-700 hover:shadow-md transition duration-200">
                    Download CSV
                </a>
                <!-- Create -->
