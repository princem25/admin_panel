    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <form method="GET" action="{{ route('products.index') }}"
            ...
            <div>
                ...
                <select name="category" class="border p-2 rounded-lg w-44 focus:ring-2 focus:ring-black outline-none">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 flex justify-between">
                                ...
                                <a href="{{ route('products.download', $product->id) }}"
                                    class="inline-block px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 text-sm">
                                    ⬇ Download
                                </a>
