<nav x-data="{ open: false }" class="relative z-50 shadow-md border-b 
        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-6">
                ...
                @if(auth()->user()->role !== 'admin')
                                <a href="{{ route('cart.index') }}" class="relative transition 
                ...
                <div class="relative" x-data="{ dropdown: false }">
                    ...
                    <button @click="dropdown = !dropdown" class="flex items-center space-x-2 transition
                    ...
                    <!-- Dropdown -->
                    <div x-show="dropdown" @click.outside="dropdown = false" x-transition x-cloak class="absolute right-0 mt-2 w-44 rounded-lg shadow-lg

                        bg-white border border-gray-200
                        dark:bg-[#2f4f54] dark:border-white/10">

                        <a href="{{ route('profile.edit') }}" class="block px-4 py-2 transition
