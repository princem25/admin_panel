...
dark:bg-white/10 dark:backdrop-blur-xl dark:border-white/20">
    ...
    <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="space-x-4 flex items-center">
            ...
            @auth
                <a href="#" class="text-gray-600 hover:text-blue-600 dark:text-white/80 dark:hover:text-cyan-400 transition">
                    Dashboard
                </a>
...
<div class="relative p-6 max-w-6xl mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-8 text-center">
        ...
        <!-- Step 1 -->
        <div class="bg-white border border-gray-200 p-6 rounded-xl shadow hover:scale-105 transition
    ...
    <!-- Overview Section -->
    <div class="mt-10 bg-white border border-gray-200 p-8 rounded-xl shadow text-center
                dark:bg-white/10 dark:backdrop-blur-xl dark:border-white/20 dark:shadow-lg">
